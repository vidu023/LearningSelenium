...
public class TestSelenium25_FluentWait {
    ...
    // we dont use it often in automation Testing
    // after every interval of 2 sec till 10 seconds it will check if the element is found or not.
...
//        }
    ...
    // wait.until(ExpectedConditions.visibilityOfElementLocated(By.className("notification-box-
